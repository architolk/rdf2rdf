...
public class uuid5 extends FunctionBase1 {
  ...
  private static final UUID NAMESPACE_X500 = UUID.fromString("6ba7b814-9dad-11d1-80b4-00c04fd430c8"); //Future feature
    ...
    try
		{
      String name = nodeValue.asString();
      String uuid5 = nameUUIDFromNamespaceAndString(NAMESPACE_URL,name).toString();
      Node node = NodeFactory.createURI("urn:uuid:"+uuid5);
      return NodeValue.makeNode(node);
  	} catch (Exception e)
		{
			throw new ExprEvalException("Error creating UUID version 5", e);
		}
	}
